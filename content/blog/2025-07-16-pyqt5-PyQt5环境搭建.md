...
title: "PyQt5-环境搭建"
date: "2025-07-16"
description: "PyQt5开发环境搭建教程，Python解释器、PyCharm编辑器与Qt模块安装配置。"
...
![Pasted image 20250722093200](/images/blog/pyqt5/Pasted%20image%2020250722093200.png)
...
![Pasted image 20250722094032](/images/blog/pyqt5/Pasted%20image%2020250722094032.png)
...
![Pasted image 20250722100029](/images/blog/pyqt5/Pasted%20image%2020250722100029.png)
...
![Pasted image 20250722100951](/images/blog/pyqt5/Pasted%20image%2020250722100951.png)
...
![Pasted image 20250722101054](/images/blog/pyqt5/Pasted%20image%2020250722101054.png)
...
![Pasted image 20250722101659](/images/blog/pyqt5/Pasted%20image%2020250722101659.png)

2）在打开的设计师界面选择`MainWindow`窗体，点击创建，如下图：

![Pasted image 20250722102048](/images/blog/pyqt5/Pasted%20image%2020250722102048.png)

3）接下来对界面进行设计，例如我设置一个简单的登录界面，如下图：

![Pasted image 20250722102705](/images/blog/pyqt5/Pasted%20image%2020250722102705.png)

4）在设计完成后保存ui文件，记住自己的路径选择，后续要用，图示如下：

![Pasted image 20250722103326](/images/blog/pyqt5/Pasted%20image%2020250722103326.png)

### 验证pyuic

1）将刚才保存的ui文件找到，使用Pycharm打开，在Pycharm界面资源管理器中找到该ui文件，右击选择 External Tools(外部工具) --> pyuic，点击完成后便会生成当前的ui文件的Python代码。如下图所示：

![Pasted image 20250722104742](/images/blog/pyqt5/Pasted%20image%2020250722104742.png)
...
![Pasted image 20250722105335](/images/blog/pyqt5/Pasted%20image%2020250722105335.png)

### 验证pyrcc

1）重新打开Qt Designer设计师，打开之前保存的ui文件，如下图：

![Pasted image 20250722165234](/images/blog/pyqt5/Pasted%20image%2020250722165234.png)

2）为该ui界面添加一个图片，成功添加后保存，如下图：

![Pasted image 20250722165825](/images/blog/pyqt5/Pasted%20image%2020250722165825.png)![Pasted image 20250722170826](/images/blog/pyqt5/Pasted%20image%2020250722170826.png)
![Pasted image 20250722171251](/images/blog/pyqt5/Pasted%20image%2020250722171251.png)

3）效果图如下，点击保存，然后再次回到Pycharm进行`pyuic`转换，这时会比之前多出一个`.qrc`文件，在该`.qrc`文件右击选择 External Tools(外部工具) --> pyrcc 进行转化，可以得到一个python文件。

![Pasted image 20250722171752](/images/blog/pyqt5/Pasted%20image%2020250722171752.png)
![Pasted image 20250722172351](/images/blog/pyqt5/Pasted%20image%2020250722172351.png)
