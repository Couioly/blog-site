---
title: "PyQt5-窗口的个性化设置"
date: "2025-08-19"
description: "PyQt5窗口个性化设置：图标、标题、背景图、样式表等定制化配置。"
...
![Pasted image 20250827102315](/images/blog/pyqt5/Pasted%20image%2020250827102315.png)
...
![Pasted image 20250827102651](/images/blog/pyqt5/Pasted%20image%2020250827102651.png)

![Pasted image 20250827102751](/images/blog/pyqt5/Pasted%20image%2020250827102751.png)
...
![Pasted image 20250827102955](/images/blog/pyqt5/Pasted%20image%2020250827102955.png)
...
![Pasted image 20250827104048](/images/blog/pyqt5/Pasted%20image%2020250827104048.png)

更换窗口图标的过程非常简单，具体操作如下：

1）选中窗口，然后在`属性编辑器`中选中`windowIcon`属性，这时会出现下拉按钮，如图所示。

![Pasted image 20250827103738](/images/blog/pyqt5/Pasted%20image%2020250827103738.png)

2）单击下拉按钮，在下拉列表中选择`选择文件`菜单项，如图所示。

![Pasted image 20250827103828](/images/blog/pyqt5/Pasted%20image%2020250827103828.png)

3）弹出`选择一个像素映射`对话框，该对话框中选择新的图标文件，单击`打开`按钮，即可将选择的图标文件作为窗口的图标，如图所示。

![Pasted image 20250827103942](/images/blog/pyqt5/Pasted%20image%2020250827103942.png)
...
![Pasted image 20250827104434](/images/blog/pyqt5/Pasted%20image%2020250827104434.png)
...
![Pasted image 20250827104838](/images/blog/pyqt5/Pasted%20image%2020250827104838.png)
...
![Pasted image 20250827105822](/images/blog/pyqt5/Pasted%20image%2020250827105822.png)
...
![Pasted image 20250827110134](/images/blog/pyqt5/Pasted%20image%2020250827110134.png)
...
![Pasted image 20250827110506](/images/blog/pyqt5/Pasted%20image%2020250827110506.png)
...
![Pasted image 20250827111304](/images/blog/pyqt5/Pasted%20image%2020250827111304.png)
...
![Pasted image 20250827111658](/images/blog/pyqt5/Pasted%20image%2020250827111658.png)
...
![Pasted image 20250827112506](/images/blog/pyqt5/Pasted%20image%2020250827112506.png)
...
![Pasted image 20250827113128](/images/blog/pyqt5/Pasted%20image%2020250827113128.png)

3）在弹出的`编辑资源`对话框中，单击左下角的第一个`新建资源文件`按钮，如图所示。

![Pasted image 20250827113217](/images/blog/pyqt5/Pasted%20image%2020250827113217.png)

4）在`新建资源文件`的对话框中，选择该资源文件保存的路径为当前Python项目的路径，然后设置文件名称为`img`，保存类型为`资源文件（*.qrc）`，最后单击`保存`按钮，如图所示。

![Pasted image 20250827113520](/images/blog/pyqt5/Pasted%20image%2020250827113520.png)

5）单击`保存`按钮后，将自动返回至`编辑资源`对话框中，然后在该对话框中选择`添加前缀`按钮，设置前缀为`png`，再单击`添加文件`按钮，如图所示。

![Pasted image 20250827113910](/images/blog/pyqt5/Pasted%20image%2020250827113910.png)

6）在`添加文件`的对话框中选择需要添加的图片文件，然后单击`打开`按钮即可，如图所示。

![Pasted image 20250827114006](/images/blog/pyqt5/Pasted%20image%2020250827114006.png)

7）图片添加完成以后，将自动返回至`编辑资源`的对话框，在该对话框中直接单击`OK`按钮即可，然后资源浏览器将显示添加的图片资源，如图所示的效果。

![Pasted image 20250827114306](/images/blog/pyqt5/Pasted%20image%2020250827114306.png)
...
![Pasted image 20250827114455](/images/blog/pyqt5/Pasted%20image%2020250827114455.png)

9）接着弹出`编辑样式表`对话框，该对话框中，单击`添加资源`后面的向下箭头，在弹出的菜单中选择`border-image`，如图所示。

![Pasted image 20250827115417](/images/blog/pyqt5/Pasted%20image%2020250827115417.png)

10）然后弹出`选择资源`对话框，该对话框中选择创建好的资源，单击`OK`按钮，如图所示。

![Pasted image 20250827115530](/images/blog/pyqt5/Pasted%20image%2020250827115530.png)

11）返回`编辑样式表`对话框，在该对话框中可以看到自动生成的代码，单击`OK`按钮即可，如图所示。

![Pasted image 20250827115613](/images/blog/pyqt5/Pasted%20image%2020250827115613.png)

12）转换资源文件

在Qt Designer中设计好窗口（该窗口中使用了`.qrc`资源文件）之后，将已经设计好的`.ui`文件转换为`.py`文件，但是转换后的`.py`文件的代码中会显示如图所示的提示信息。

![Pasted image 20250827115913](/images/blog/pyqt5/Pasted%20image%2020250827115913.png)

图中的提示信息说明`img_rc`模块导入出现异常，所以此处需要将已经创建好的`img.qrc`资源文件转换为`.py`文件，这样在设计窗口中才可以正常使用，资源文件转换的具体步骤如下：

- 在 [PyQt5-环境搭建](/blog/2025-08-16-pyqt5-PyQt5环境搭建) 中已搭建好资源文件转化工具`Pyrcc`，接下来将使用它进行资源文件转化。
...
![Pasted image 20250827121213](/images/blog/pyqt5/Pasted%20image%2020250827121213.png)

- 文件转换完以后，提示的报错信息即可消失，然后添加程序入口，并在其中通过`MainWindow`对象的`show()函数`来显示主窗口，运行效果如图。

![Pasted image 20250827121454](/images/blog/pyqt5/Pasted%20image%2020250827121454.png)
...
![Pasted image 20250827135243](/images/blog/pyqt5/Pasted%20image%2020250827135243.png)

控制窗口透明度的具体操作如下：

选中窗口，然后在`属性编辑器`中设置`windowOpacity`属性的值即可，如图所示。

![Pasted image 20250827135515](/images/blog/pyqt5/Pasted%20image%2020250827135515.png)
...
![Pasted image 20250827141328](/images/blog/pyqt5/Pasted%20image%2020250827141328.png)
